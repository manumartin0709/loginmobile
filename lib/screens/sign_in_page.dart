  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Center(
          ...
          const GoogleSignIn(clientId: '955271184769-lf4b5ugj5ppsdb9d48v8i2ii5ghm9a2v.apps.googleusercontent.com',),
...
class GoogleSignIn extends StatefulWidget {
  const GoogleSignIn({super.key, required String clientId});
